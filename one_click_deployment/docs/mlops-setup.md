...
git add README.md docs .gitignore one_click_deployment/resources/README.md
...
Follow the instructions in [one_click_deployment/resources/README.md](../one_click_deployment/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../one_click_deployment/resources/README.md)  to propose, test, and deploy
