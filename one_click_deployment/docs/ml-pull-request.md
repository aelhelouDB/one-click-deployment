...
To push your updated ML code to production, [open a pull request]() against the remote Git repo containing the current project.
...
Opening a pull request will trigger a[workflow](../.github/workflows/one_click_deployment-run-tests.yml) 
...
Links:
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/one_click_deployment/one_click_deployment-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/one_click_deployment/one_click_deployment-model)
. 
